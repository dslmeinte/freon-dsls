...
/**
 * Class 'CustomLIonCoreTyperPart' is meant to be a convient place to add any
 * custom code for type checking.
 */
export class CustomLIonCoreTyperPart implements PiTyperPart {
    mainTyper: LIonCoreTyper;
