...
import { PiElement, PiType, Language, PiTyper } from "@projectit/core";

import { projectitConfiguration } from "../../config/ProjectitConfiguration";
import { LIonCoreTyperPart } from "./LIonCoreTyperPart";
import { ListUtil } from "../../utils/gen/ListUtil";

/**
 * Class LIonCoreTyper implements the typer generated from, if present, the typer definition,
 * otherwise this class implements the default typer.
 */
export class LIonCoreTyper implements PiTyper {
    private generatedTyper: LIonCoreTyperPart;

    constructor() {
        this.generatedTyper = new LIonCoreTyperPart();
