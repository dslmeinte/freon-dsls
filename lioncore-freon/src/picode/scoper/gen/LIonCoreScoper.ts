...
const LOGGER = new PiLogger("LIonCoreScoper");

/**
 * Class LIonCoreScoper implements the scoper generated from, if present, the scoper definition,
 * otherwise this class implements the default scoper.
 */
export class LIonCoreScoper implements PiScoper {
    ...
    public resolvePathName(basePosition: PiElement, doNotSearch: string, pathname: string[], metatype?: LIonCoreMetaType): PiNamedElement {
