...
import { LIonCoreEveryConcept, Metamodel, MetamodelElement } from "../../language/gen";
...
/**
 * Class LIonCoreModelUnitWriter provides methods to return a string representation of an instance of
 * elements of language LIonCore.
 * It is, amongst others, used to create error messages in the validator.
 */
export class LIonCoreModelUnitWriter implements PiWriter {
     ...
     * @param short
     */
    public writeToString(modelelement: LIonCoreEveryConcept, startIndent?: number, short?: boolean): string {
     ...
     * @param short
     */
    public writeToLines(modelelement: LIonCoreEveryConcept, startIndent?: number, short?: boolean): string[] {
     ...
     * @param modelelement
     */
    public writeNameOnly(modelelement: LIonCoreEveryConcept): string {
    ...
    private unparse(modelelement: LIonCoreEveryConcept, short: boolean) {
        if (!modelelement) return;
        switch (modelelement.piLanguageConcept()) {
            case "MetamodelElement":
                this.unparseMetamodelElement(modelelement as MetamodelElement, short);
                break;
            case "Metamodel":
                this.unparseMetamodel(modelelement as Metamodel, short);
                break;
        }
    }

    /**
     * Unparsing of 'Metamodel' according to projection 'default'.
     */
    private unparseMetamodel(modelelement: Metamodel, short: boolean) {
        const blockIndent = this.output[this.currentLine].length;
        // do the first line
        this.output[this.currentLine] += `metamodel `;
        this.output[this.currentLine] += `"${modelelement.qualifiedName}" `;
    ...
    /**
     * The abstract concept 'MetamodelElement' is not unparsed.
     */
    private unparseMetamodelElement(modelelement: MetamodelElement, short: boolean) {
        throw new Error("Method unparseMetamodelElement should be implemented by its (concrete) subclasses.");
    }
     ...
     */
    private unparseList(
        list: LIonCoreEveryConcept[],
        sepText: string,
        sepType: SeparatorType,
        vertical: boolean,
        indent: number,
        short: boolean,
        method: (modelelement: LIonCoreEveryConcept, short: boolean) => void
    ) {
