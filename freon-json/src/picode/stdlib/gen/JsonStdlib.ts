...
/**
 * Class JsonStdlib provides an entry point for all predefined elements in language Json.
 ...
 */
export class JsonStdlib implements PiStdlib {
    ...
    public static getInstance(): PiStdlib {
        if (this.stdlib === undefined || this.stdlib === null) {
            this.stdlib = new JsonStdlib();
        }
        return this.stdlib;
    }

    public elements: PiNamedElement[] = []; // the predefined elements of language Json
     ...
     * @param metatype
     */
    public find(name: string, metatype?: JsonMetaType): PiNamedElement {
        if (!!name) {
