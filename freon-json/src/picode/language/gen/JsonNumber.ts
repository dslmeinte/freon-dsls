...
/**
 * Class JsonNumber is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to changes in the state of its properties.
 */
export class JsonNumber extends JsonValue implements PiElement {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data
     */
    static create(data: Partial<JsonNumber>): JsonNumber {
        const result = new JsonNumber();
        if (!!data.value) {
    ...
    readonly $typename: JsonMetaType = "JsonNumber"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<JsonNumber>): boolean {
