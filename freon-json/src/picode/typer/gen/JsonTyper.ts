...
import { JsonTyperPart } from "./JsonTyperPart";
import { ListUtil } from "../../utils/gen/ListUtil";

/**
 * Class JsonTyper implements the typer generated from, if present, the typer definition,
 * otherwise this class implements the default typer.
 */
export class JsonTyper implements PiTyper {
    private generatedTyper: JsonTyperPart;

    constructor() {
        this.generatedTyper = new JsonTyperPart();
